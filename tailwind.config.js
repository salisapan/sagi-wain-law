...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        gold: '0 20px 60px -18px rgba(47,95,168,0.5)',
        'gold-lg': '0 30px 80px -20px rgba(47,95,168,0.6)',
      ...
      backgroundImage: {
        'gold-metallic':
          'linear-gradient(135deg, #E8F0FC 0%, #9CC3EC 20%, #2F5FA8 45%, #1B3A6B 70%, #9CC3EC 88%, #E8F0FC 100%)',
      ...
      keyframes: {
        ...
        'glow-pulse': {
          '0%, 100%': { boxShadow: '0 0 0 0 rgba(47,95,168,0.45)' },
          '50%': { boxShadow: '0 0 24px 6px rgba(47,95,168,0.35)' },
        },
        'marquee-right': {
